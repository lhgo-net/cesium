...
L.TileLayer.lhgoProvider = L.TileLayer.extend({
  initialize: function (type, options) {
    // (type, Object)
    var providers = L.TileLayer.lhgoProvider.providers
...
L.TileLayer.lhgoProvider.providers = {
  ...
  GaoDe: {
    Normal: {
      Map: 'http://webrd04.is.autonavi.com/appmaptile?lang=zh_cn&size=1&scale=1&style=8&x={x}&y={y}&z={z}&key=c457ed897a46940edffcc64fca6a6adc'
    },
    Satellite: {
  ...
  Geoq: {
    Normal: {
      Map: 'https://geohub.amap.com/mapstyle/mapshare/1d6be824292a822d8cf7701f1b3d13fa',
      PurplishBlue:
...
L.tileLayer.lhgoProvider = function (type, options) {
  return new L.TileLayer.lhgoProvider(type, options)
}
