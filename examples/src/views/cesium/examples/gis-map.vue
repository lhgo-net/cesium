...
import test from '@/assets/Untitled-1.json'
...
const defData = computed(() => test.data.gtTaxiLatAndLngDtos)

let map = null
const initMap = () => {
  // L.TileLayer.lhgoProvider.providers = {
  //   TianDiTu: {
  //     Normal: {
  ...
  //     key: '3b84cd1b17e647232cea604dc844bc98'
  //   }
  // }
  const imagesLayer = L.tileLayer.lhgoProvider('GaoDe.Normal.Map', {
    minZoom: 1,
    maxZoom: 19
  })
...
.leaflet-tile-container img {
  /*  filter: invert(1) grayscale(0) saturate(0.5) brightness(1.6) opacity(1) hue-rotate(334deg) sepia(10%) !important; */
  /* 设置： invert：翻转颜色  saturate：饱和度  brightness：亮度 */
  -webkit-filter: invert(1) saturate(5) brightness(0.9) hue-rotate(26deg) !important;
  -moz-filter: invert(1) saturate(5) brightness(0.9) hue-rotate(26deg) !important;
  filter: invert(1) saturate(5) brightness(0.9) hue-rotate(26deg) !important;
}
</style>
