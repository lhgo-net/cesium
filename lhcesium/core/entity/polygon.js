import { getCircleGradient } from "../util/canvas/init";
export class Polygon {
  constructor(viewer) {
    this.viewer = viewer;
  }
  gradient(_dataSource,outlineColor = Cesium.Color.LIGHTSKYBLUE, baseColor = 'rgb(156, 220, 254)',coverColor = 'rgba(255,0,0,0.3)' ) {
    let entityIds = [];
    ...
    Cesium.GeoJsonDataSource.load(_dataSource).then((datasource) => {
